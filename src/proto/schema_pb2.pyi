...
class Block(_message.Message):
    __slots__ = ["curr_hash", "difficulty", "merkle_root", "miner_pub_key", "nonce", "prev_hash", "reward", "trans"]
    ...
    def __init__(self, prev_hash: _Optional[str] = ..., curr_hash: _Optional[str] = ..., nonce: _Optional[int] = ..., merkle_root: _Optional[str] = ..., trans: _Optional[_Iterable[_Union[Transaction, _Mapping]]] = ..., miner_pub_key: _Optional[str] = ..., reward: _Optional[int] = ..., difficulty: _Optional[int] = ...) -> None: ...
